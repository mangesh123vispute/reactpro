...
export default function Hosting() {
  ...
  const data = [
    {
      no: "1",
      img: "images/img_download1.png",
      imgtxt: "Builder 1",
      txt1: "WixPro 72-Inch Responsive Website Builder-Comprehensive Digital Platform CreationTool, Streamlined Design Interface forProfessional Websites and Online Stores (Black/Blue)",
      txt2: "[What You Get]: Receive the WixPro website builder suite, access to premium design templates, an extensive library of widgets and apps, and detailed step-by-step guides.",
      rate: "9.8",
      review: "Exceptional",
      star: "images/img_image_amber_500.svg",
      lebel: "best Choice",
      lebelImg: "images/img_image_white_a700.svg",
    },
    {
      no: "2",
      img: "images/img_download1.png",
      imgtxt: "Builder",
      txt1: "SiteCraft 68-Inch Ultimate Web Design Studio- Advanced Site Creation Toolkit, Intuitive Drag-and-Drop Editor for Dynamic Websites and E-commerce Platforms (Green/White)",
      txt2: "[What You Get]: Gain access to the SiteCraft design studio, featuring a robust selection of design elements, SEO optimization tools, and e-commerce integrations.",
      rate: "9.5",
      review: "Excellent",
      star: "images/img_image_amber_500_11x66.svg",
      lebel: "Best Value",
      lebelImg: "images/img_settings.svg",
    },
    {
      no: "3",
      img: "images/img_download1.png",
      ...
      <div className="flex flex-col justify-start w-full">
        ...
        >
          {data.map((host) => (
            <div
              key={host.no}
              className="sm:h-[254px] h-[270px] md:h-[616px] relative w-full"
            >
              ...
              {host.lebel && (
                <Button
                  ...
                  color="yellow_900"
                >
                  <div className="text-base text-left">{host.lebel}</div>
                </Button>
              )}
